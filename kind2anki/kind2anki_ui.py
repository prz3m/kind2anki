...
class Ui_kind2ankiDialog(object):
    def setupUi(self, kind2ankiDialog):
        ...
        self.includeUsage = QtGui.QCheckBox(self.groupBox)
        self.includeUsage.setObjectName(_fromUtf8("includeUsage"))
    ...
    def retranslateUi(self, kind2ankiDialog):
        ...
        self.includeUsage.setText(_("Include usage example"))
        self.doTranslate.setText(_("Translate words"))
        self.label.setText(_("Target language:"))
        self.label_3.setText(_("Import words not older than"))

...
class Ui_kind2ankiDialog(object):
    def setupUi(self, kind2ankiDialog):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=kind2ankiDialog)
        ...
        self.includeUsage = QtWidgets.QCheckBox(parent=self.groupBox)
        ...
        self.importDays = QtWidgets.QSpinBox(parent=self.groupBox)
        ...
        self.languageSelect = QtWidgets.QComboBox(parent=self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.doTranslate = QtWidgets.QCheckBox(parent=self.groupBox)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=kind2ankiDialog)
        ...
        self.buttonBox.accepted.connect(kind2ankiDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(kind2ankiDialog.reject) # type: ignore
